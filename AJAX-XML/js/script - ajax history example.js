...
function setupLinks() {
  ...
  ajaxify_link(document.getElementById("cameramen-link"));
  ajaxify_link(document.getElementById("the-watchers-link"));
}
...
function changeBrowserURL(dom_element) {
  ...
  if (history.pushState) {
    ...
    history.pushState(null, dom_element.title, dom_element.href);
  }
